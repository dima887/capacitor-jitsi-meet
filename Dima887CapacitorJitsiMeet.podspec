  ...
  Pod::Spec.new do |s|
    s.name = 'Dima887CapacitorJitsiMeet'
    s.version = '7.1.0'
    ...
    s.license = 'MIT'
    s.homepage = 'https://github.com/dima887/capacitor-jitsi-meet'
    s.author = 'Dima Movchan'
    s.source = { :git => 'https://github.com/dima887/capacitor-jitsi-meet', :tag => s.version.to_s }
